...
MedImager 是一款开源医学影像查看与分析工具，长期目标是逐步接近 RadiAnt 级阅片工作流。2.0 版本将 1.0 与 1.x 的成果合并为可靠的 2D DICOM 基线：多序列查看、测量与 ROI 分析、专业合成 DICOM 测试覆盖、标注持久化和可重复性能基准。
...
创建一款可逐步成长到 RadiAnt 级工作流的开源医学影像查看器。MedImager 2.0 已具备作为稳定 2D 基础版本发布的条件；后续版本应在此基础上推进 MPR、DICOMDIR/PACS、挂片布局和更完整的临床式阅片工作流。
